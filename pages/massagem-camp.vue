...
<template>
  <div style="font-family:'Nunito',sans-serif; background:#FAF8F4; color:#2D2825; overflow-x:hidden;">
    ...
    <!-- ── BOTÃO AGENDE AGORA (fixo no topo) ── -->
    <div style="
      position:sticky; top:0; left:0; right:0; z-index:100;
      background:linear-gradient(90deg, #A67B2A 0%, #C4943E 100%);
      padding:0.75rem 1.5rem; text-align:center;
      box-shadow:0 2px 16px rgba(166,123,42,0.3);
    ">
      <a :href="waLink" target="_blank" rel="noopener" @click="trackWhatsApp('header')" style="
        display:inline-flex; align-items:center; gap:0.6rem;
        background:white; color:#A67B2A; font-weight:800; font-size:1rem;
        padding:0.65rem 2rem; border-radius:9999px; text-decoration:none;
